...
# Cargar el conjunto de datos (por ejemplo, "saratoga_houses.csv")
data = pd.read_csv("sataroga_houses.csv")
...
data.fillna(method="ffill", inplace=False)
...
sns.histplot(data["ventas"], bins=30, kde=True)
plt.xlabel("Ventas")
